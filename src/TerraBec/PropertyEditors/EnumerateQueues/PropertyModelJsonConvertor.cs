...
namespace Terrabec.PropertyEditors.EnumerateQueues
{
	public class PropertyModelJsonConvertor : JsonConverter
	{
		...
		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			...
			model.queueId = item.GetValue(JsonHelper.PropertyName<PropertyModel>(nameof(PropertyModel.queueId)), StringComparison.InvariantCultureIgnoreCase)?.Value<string>();
		...
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
		{
			...
			writer.WritePropertyName(JsonHelper.PropertyName<PropertyModel>(nameof(PropertyModel.queueId)));
			writer.WriteValue(model.queueId);
