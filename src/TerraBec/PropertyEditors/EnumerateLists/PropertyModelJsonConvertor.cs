...
namespace Terrabec.PropertyEditors.EnumerateLists
{
	public class PropertyModelJsonConvertor : JsonConverter
	{
		...
		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			...
			model.listId = item.GetValue(JsonHelper.PropertyName<PropertyModel>(nameof(PropertyModel.listId)), StringComparison.InvariantCultureIgnoreCase)?.Value<string>();
		...
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
		{
			...
			writer.WritePropertyName(JsonHelper.PropertyName<PropertyModel>(nameof(PropertyModel.listId)));
			writer.WriteValue(model.listId);
